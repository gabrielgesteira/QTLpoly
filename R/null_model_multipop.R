...
#'
#' @export null_model_multipop
#' @import parallel

null_model_multipop <- function(data, offset.data = NULL, pheno.col = NULL, n.clusters = NULL, plot = NULL, verbose = TRUE) {
  ...
  G = SharedObject::share(G)
  tau <- c()
  X <- matrix(1, length(ind))
  ## clusterExport(cl, c("G","X","tau","score.test"))
