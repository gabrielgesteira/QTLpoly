...
In order to run this tutorial, you will need to install the `qtlpoly` package, which is available on its development version at [GitHub](https://github.com/guilherme-pereira/qtlpoly). You can install all needed packages within R using the commands below:
